    ...
    render() {
        return (
            <div id="aboutContainer">
                <ul id="aboutButtons">
                    <li className="bottomAnim" id="basisSenior"><a href="http://www.basised.com/phoenix/">
                        <h2>BASIS Phoenix Senior</h2>
                        <img id="basisLogo" src={require('../res/logos/basisphx.png')} alt="basis phx"/>
                    </a></li>
                    <li className="bottomAnim" id="gocodeFounder"><a href="http://gocode.courses">
                        <h2>GoCode Founder</h2>
                        <img id="basisLogo" src={require('../res/logos/gocode.png')} alt="basis phx"/>
                    </a></li>
                    <li className="bottomAnim" id="tgfBoard"><a href="http://thegeniusfactory.org">
